...
var app = angular.module('keycloak-tutorial', ['ngRoute', 'appControllers']);
...
app.config(['$httpProvider', function ($httpProvider) {
    ...
    if (isExpired) {
        window._keycloak.updateToken(5).success(function () {
...
app.run(['$rootScope', '$location', '$http', '$route', function ($rootScope, $location, $http, usersService, $route) {}]);
